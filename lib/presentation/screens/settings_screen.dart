          ...
          return Padding(
            ...
            child:
              ...
              ListTile(
                title: Text('Theme'),
                onTap: () {
                  context.read<SettingsCubit>().toggleTheme(!state.isDarkMode);
                },
                subtitle:
                    state.isDarkMode ? Text('Light theme') : Text('Dark theme'),
              ...
              ListTile(
                ...
                subtitle: state.isGrid ? Text('List view') : Text('Grid view'),
